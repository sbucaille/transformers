...
class RTDetrPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, RTDetrLoss):
...
class RTDetrHungarianMatcher(DetrHungarianMatcher):
    def __init__(
        self,
        class_cost: float = 1,
        bbox_cost: float = 1,
...
class RTDetrLoss(DetrLoss):
    def __init__(self, config, losses, weight_dict):
        ...
        self.matcher = RTDetrHungarianMatcher(
            class_cost=config.matcher_class_cost,
            bbox_cost=config.matcher_bbox_cost,
            giou_cost=config.matcher_giou_cost,
...
class RTDetrForObjectDetectionCriterion(DetrForObjectDetectionCriterion):
    def __init__(self, config):
        super().__init__(config)
        losses = ["vfl", "boxes"]
        weight_dict = {
        ...
        self.loss_module = RTDetrLoss(config, losses, weight_dict)
...
class RTDetrForObjectDetection(RTDetrPreTrainedModel):
    ...
    def __init__(self, config: RTDetrConfig):
        ...
        self.criterion = RTDetrForObjectDetectionCriterion(config)
