...
class RTDetrLoss(nn.Module):
    """
    This class computes the losses for RTDetrForObjectDetection/RTDetrForSegmentation. The process happens in two steps: 1)
...
class RTDetrForObjectDetectionCriterion(nn.Module):
    def __init__(self, config):
        super().__init__()
        requires_backends(self, ["scipy"])
        losses = ["vfl", "boxes"]
